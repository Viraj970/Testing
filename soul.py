...
user_attacks = {}
bot_token = '6513294807:AAH_XFupPCKsMzOEgqMyHzek5TA37SjCSNc'
proxy_api_url = 'https://api.proxyscrape.com/v2/?request=displayproxies&protocol=http,socks4,socks5&timeout=500&country=all&ssl=all&anonymity=all'

proxy_iterator = None
current_proxy = NoneSOUL

def get_proxies():
    global proxy_iterator
    try:
        response = requests.get(proxy_api_url)SOUL
